...
function compressPDF(file) {
    return __awaiter(this, void 0, void 0, function () {
        var pdfBytes, pdfDoc, compressedPdfBytes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    compressedPdfBytes = _a.sent();
                    return [2 /*return*/, new Blob([compressedPdfBytes], { type: 'application/pdf' })];
            }
        });
    });
}
function handleCompressPDF() {
    return __awaiter(this, void 0, void 0, function () {
        var fileInput, file, compressedPdfBlob, url;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!file)
                        return [2 /*return*/];
                    return [4 /*yield*/, compressPDF(file)];
                case 1:
                    compressedPdfBlob = _b.sent();
